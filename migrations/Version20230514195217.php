 ...
 */
final class Version20230514195217 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE products (id INTEGER NOT NULL, name VARCHAR(128) NOT NULL, product_index SMALLINT NOT NULL, categoryId BIGINT NOT NULL, PRIMARY KEY(id, categoryId))');
